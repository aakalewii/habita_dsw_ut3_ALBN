...
class ApiMueblesService
{
    ...
    {
        return Http::acceptJson()->get("{$this->baseUrl}/muebles", $filtros);
    }

    public function verMueble(int $id)
    {
        return Http::acceptJson()->get("{$this->baseUrl}/muebles/{$id}");
    }

    public function listarCategorias(array $filtros = [])
    {
        return Http::acceptJson()->get("{$this->baseUrl}/categorias", $filtros);
    }

    public function verCategoria(int $id)
    {
        return Http::acceptJson()->get("{$this->baseUrl}/categorias/{$id}");
    }
    ...
    {
        return Http::acceptJson()->withToken(Session::get('api_token'))
